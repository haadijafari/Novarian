# Generated by Django 5.2.3 on 2025-08-14 20:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='carts', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Full Description')),
                ('slug', models.SlugField(blank=True, default='', max_length=200, unique=True, verbose_name='Slug')),
                ('view_count', models.PositiveIntegerField(default=0, verbose_name='View Count')),
                ('is_active', models.BooleanField(db_index=True, default=True, help_text='Turn off for Soft Delete', verbose_name='Active Status')),
                ('is_draft', models.BooleanField(default=True, verbose_name='Draft')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Created Date')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='Modified Date')),
                ('published_date', models.DateTimeField(db_index=True, default=django.utils.timezone.now, verbose_name='Published Date')),
                ('category', models.ManyToManyField(blank=True, related_name='product_categories', to='product.category', verbose_name='Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_received_product_image', models.ImageField(blank=True, null=True, upload_to='product_images/reviews', verbose_name='User Received Product Image')),
                ('rating', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.0')), django.core.validators.MaxValueValidator(Decimal('5.0'))], verbose_name='Rating')),
                ('description_title', models.CharField(max_length=128, verbose_name='Description Title')),
                ('description', models.TextField(verbose_name='Description')),
                ('is_active', models.BooleanField(db_index=True, default=False, help_text='Set True for confirmed reviews (Set False for Soft Delete)', verbose_name='Active Status')),
        ...
        migrations.AddIndex(
            model_name='cart',
            index=models.Index(fields=['user', 'is_paid'], name='product_car_user_id_a53e35_idx'),
        ),
        migrations.AddIndex(
            model_name='cart',
            index=models.Index(fields=['created_date'], name='product_car_created_b23ec5_idx'),
        ),
